...
const skills = {
  ...
  Backend: ['Node.js', 'PostgreSQL', 'Prisma', 'tRPC/REST', 'Auth.js'],
  Tools: ['Vercel', 'Git/GitHub', 'Playwright', 'Jest', 'Figma'],
}
      ...
      <div className="grid items-center gap-8 md:grid-cols-2">
        ...
        <Reveal>
          <div className="relative mx-auto h-60 w-60 overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg">
            ...
            <Image
              src="/public/images/Me.jpeg" /* must start with / and match file case exactly */
